<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"H:\phpStudy\WWW\tp5\public/../application/admin\view\links\edit.htm";i:1501488385;s:67:"H:\phpStudy\WWW\tp5\public/../application/admin\view\common\top.htm";i:1501637880;s:68:"H:\phpStudy\WWW\tp5\public/../application/admin\view\common\left.htm";i:1501728330;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="title" placeholder="" name="title" required="" type="text" value="<?php echo $Links['title']; ?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="url" placeholder="" name="url" required="" type="text" value="<?php echo $Links['url']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
