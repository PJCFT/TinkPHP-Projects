<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"H:\phpStudy\WWW\tp5\public/../application/admin\view\article\edit.htm";i:1501742772;s:67:"H:\phpStudy\WWW\tp5\public/../application/admin\view\common\top.htm";i:1501637880;s:68:"H:\phpStudy\WWW\tp5\public/../application/admin\view\common\left.htm";i:1501728330;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                    ...
                                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <?php if($Article['pic'] != ''): ?>
                                                    <img src="__IMG__<?php echo $Article['pic']; ?>" height="50">
                                                <?php else: ?>
                                                    暂无缩略图
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="cateid" id="">
                                                    ...
                                                    <option 
                                                    <?php if($vo['id'] == $Article['cateid']): ?>
                                                    selected="selected"
                                                    <?php endif; ?>
                                                    value="<?php echo $vo['id']; ?>"
                                                    ><?php echo $vo['catename']; ?></option>
...
UE.getEditor('content',{initialFrameWidth:650,initialFrameHeight:400,});
</script>
</body>
</html>