<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"H:\phpStudy\WWW\tp5\public/../application/admin\view\links\lst.htm";i:1501743524;s:67:"H:\phpStudy\WWW\tp5\public/../application/admin\view\common\top.htm";i:1501637880;s:68:"H:\phpStudy\WWW\tp5\public/../application/admin\view\common\left.htm";i:1501728330;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
    ...
    <link rel="stylesheet" href="http://fontawesome.io/assets/font-awesome/css/font-awesome.css"><!-- 通过网络加载资源 -->
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                            <tr>
                                                ...
                                                <td align="center"><a href="<?php echo $vo['url']; ?>" target="_blank"><?php echo $vo['url']; ?></td>
                                                <td align="center">
                                                    <?php if($vo['desc'] != ''): ?>
