<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"H:\phpStudy\WWW\tp5\public/../application/index\view\index\index.html";i:1529420082;s:71:"H:\phpStudy\WWW\tp5\public/../application/index\view\common\header.html";i:1501744322;s:70:"H:\phpStudy\WWW\tp5\public/../application/index\view\common\right.html";i:1501724847;s:71:"H:\phpStudy\WWW\tp5\public/../application/index\view\common\footer.html";i:1501744244;}*/ ?>
...
<div class="overall">
	...
	<div class="left">
		<?php if(is_array($articleres) || $articleres instanceof \think\Collection || $articleres instanceof \think\Paginator): $i = 0; $__LIST__ = $articleres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<div class="xnews2">
				<div class="pic"><a target="_blank" href="#"><img src="<?php if($vo['pic'] != ''): ?>__IMG__<?php echo $vo['pic']; else: ?>__PUBLIC__/images/error.png<?php endif; ?>" alt="<?php echo $vo['title']; ?>"/></a></div>
				<div class="dec">
					<h3><a target="" href="<?php echo url('article/index',array('arid'=>$vo['id'])); ?>"><?php echo $vo['title']; ?></a></h3>
					...
					<?php
						...
						foreach ($arr as $k=>$v) {
							echo "<a href='http://www.tp5.com/index.php/index/search/index?keywords=$v'>$v</a>";
						}
					?>
					</div><!-- <a href='http://127.0.0.1/tp5/public/index.php/index/search/index?keywords=$v'>$v</a> -->
				</div>
			</div>
		<?php endforeach; endif; else: echo "" ;endif; ?>		
		<div class="pages">
...
<div class="footerd">
	<ul>
	<li>Copyright &#169; 2008-2016  all rights reserved 版权所有   <a href="#" target="_blank" rel="nofollow">蜀icp备08107937号</a></li> 
	</ul>
</div>

<div style="display:none;">
	<script src="__PUBLIC__/style/count_zixun.js" language="JavaScript"></script>
</div>
